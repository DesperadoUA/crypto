 ...
 *
 * Checks against the WordPress server at crypto.wordpress.org. Will only check
...
function wp_version_check( $extra_stats = array(), $force_check = false ) {
	...
	$url      = 'http://crypto.wordpress.org/core/version-check/1.7/?' . http_build_query( $query, '', '&' );
	$http_url = $url;
