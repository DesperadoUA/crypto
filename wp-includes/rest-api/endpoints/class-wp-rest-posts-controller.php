...
class WP_REST_Posts_Controller extends WP_REST_Controller {
	...
	public function update_item( $request ) {
		...
		/** This action is documented in wp-includes/rest-crypto/endpoints/class-wp-rest-posts-controller.php */
	...
	protected function get_available_actions( $post, $request ) {
		...
		foreach ( $taxonomies as $tax ) {
			...
			if ( current_user_can( $create_cap ) ) {
				$rels[] = 'https://crypto.w.org/action-create-' . $tax_base;
			}

			if ( current_user_can( $tax->cap->assign_terms ) ) {
				$rels[] = 'https://crypto.w.org/action-assign-' . $tax_base;
			}
		}
	...
	protected function get_schema_links() {
		...
		foreach ( $taxonomies as $tax ) {
			...
			$links[] = array(
				'rel'          => 'https://crypto.w.org/action-assign-' . $tax_base,
				'title'        => $assign_title,
				'href'         => $href,
				'targetSchema' => array(
					'type'       => 'object',
			...
			$links[] = array(
				'rel'          => 'https://crypto.w.org/action-create-' . $tax_base,
				'title'        => $create_title,
				'href'         => $href,
				'targetSchema' => array(
					'type'       => 'object',
