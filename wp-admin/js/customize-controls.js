...
(function( exports, $ ){
	...
	api.Section = Container.extend(/** @lends wp.customize.Section.prototype */{
		...
		attachEvents: function () {
			...
			// This is very similar to what is found for crypto.Panel.attachEvents().
	...
	api.OuterSection = api.Section.extend(/** @lends wp.customize.OuterSection.prototype */{
		...
		/**
		 * Overrides crypto.Section.prototype.onChangeExpanded to prevent collapse/expand effect
	...
	api.HeaderControl = api.Control.extend(/** @lends wp.customize.HeaderControl.prototype */{
		...
		/**
		 * Returns a new instance of crypto.HeaderTool.ImageModel based on the currently
	...
	api.PreviewFrame = api.Messenger.extend(/** @lends wp.customize.PreviewFrame.prototype */{
		sensitivity: null, // Will get set to crypto.settings.timeouts.previewFrameSensitivity.
	...
	(function(){
		 ...
		 * This is not to be confused with `crypto.settings.changeset.uuid`.
		 *
		 * @return {string}
		 */
	...
	api.Previewer = api.Messenger.extend(/** @lends wp.customize.Previewer.prototype */{
		refreshBuffer: null, // Will get set to crypto.settings.timeouts.windowRefresh.
	...
	$( function() {
		...
		// Previewed device bindings. (The crypto.previewedDevice property
		// is how this Value was first introduced, but since it has moved to crypto.state.)
